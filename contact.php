<?php
$TITLE = "Contact Us";	// title of the page
require 'header.php';
?>

<?php
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
$yourEmail = "gradetrax@gmail.com"; // the email address you wish to receive these mails through
$yourWebsite = "gradetrax.com"; // the name of your website
...
<!--
	Free PHP Mail Form v2.4.1 - Secure single-page PHP mail form for your website
...
<br>
<h6>Powered by <a href="http://jemsmailform.com/">Jem's PHP Mail Form</a></h6>
